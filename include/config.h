...
// ==================== WiFi Configuration ====================
// ⚠️ CHANGE THESE TO YOUR NETWORK CREDENTIALS!
...
#define FETCH_INTERVAL_MS       (15UL * 60UL * 1000UL)  // 15 minutes
#define DISPLAY_DURATION_MS     (10UL * 1000UL)          // 10 seconds per alert
#define SCROLL_SPEED_MS         50                        // Text scroll speed
...
#define PANEL_HEIGHT    32      // Panel height (32 or 64)
...
#define USGS_URL        "http://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_day.geojson"
#define GDACS_URL       "http://www.gdacs.org/gdacsapi/api/events/geteventlist/SEARCH"
